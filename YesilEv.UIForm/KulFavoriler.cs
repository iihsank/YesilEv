...
{
    public partial class KulFavoriler : Form
    {
        ...
        public KulFavoriler(KullaniciGosterDTO kullanici):this()
        {
            this.kullanici = kullanici;
        }

        private void KulFavoriler_Load(object sender, EventArgs e)
        {
            UrunlerGetir();
            //Gizle();
        }
        ...
        private void UrunlerGetir()
        {
            ...
            List<UrunGetirDTO> liste= dal.FavListeGetir(this.kullanici.KullaniciId);
            if (liste.Count > 0)
            {
